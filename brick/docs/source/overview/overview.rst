...
프로그램 간 라이브러리 호환성 문제와 자원 분배 등 여러 문제가 발생할 것입니다.

또한 기존 하이퍼바이저 기반의 가상화 기술에 비해 오버헤드가 거의 없이,
...
|
하지만 증가하는 컨테이너 기반 환경에서 다양한 컴퓨팅 자원의 효과적인 사용과, 
복잡한 구성자원의 효율적인 운영 및 통합관리 등을 위해서는 솔루션이 필요합니다.
Kubernetes 기반의 컨테이너 통합 관리 솔루션 Brick은 
이러한 컨테이너를 보다 편리하게 사용하고 관리할 수 있는 플랫폼을 지향합니다.
