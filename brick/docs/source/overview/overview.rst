...
.. note::
   ...
   증가하는 컨테이너 기반 환경에서 다양한 컴퓨팅 자원의 효과적인 사용과, 
   복잡한 구성자원의 효율적인 운영 및 관리 등을 위해서는 솔루션이 필요합니다.
   Brick은 Kubernetes 기반의 컨테이너 통합 관리 솔루션으로,
   컨테이너를 보다 편리하게 사용하고 관리할 수 있는 플랫폼 제공을 지향합니다.
